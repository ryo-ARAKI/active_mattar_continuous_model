...
\begin{empheq}{align}
  \abs{\vb*{v}} &= \abs{v_0 \vb*{e}_x + \varepsilon_\parallel \vb*{e}_x + \varepsilon_\bot \vb*{e}_y}^2 \nonumber \\
    ...
    &\approx v_0^2 + 2 v_0 \varepsilon_\parallel \qquad \vb*{v_0} \cdot \vb*{\varepsilon}_\bot = 0
...
\subsubsection*{\ref{eq:continuous_model}の摂動に対するリーディングオーダーについて}
...
\begin{empheq}{align}
  \sigma \hat{\vb*{\varepsilon}} + \mathrm{i} k_x v_0 \hat{\vb*{\varepsilon}} &= - \mathrm{i} \vb*{k} \hat{\eta} + 2\mathrm{i} \vb*{k} \lambda_1 v_0 \hat{\varepsilon}_\parallel + \mqty(2\alpha & 0 \\ 0 & 0) \hat{\vb*{\varepsilon}} - k^2 \Gamma_0 \hat{\vb*{\varepsilon}} - k^4 \Gamma_2 \hat{\vb*{\varepsilon}} \nonumber \\
  \sigma \hat{\vb*{\varepsilon}} &= -\mathrm{i} \qty{ \hat{\eta} -2v_0 \lambda_1 \hat{\varepsilon}_\parallel } \vb*{k} + \qty{ \mqty(2\alpha & 0 \\ 0 & 0) - k^2 \Gamma_0 - k^4 \Gamma_2 - \mathrm{i} k_x v_0 } \hat{\vb*{\varepsilon}}
\end{empheq}
